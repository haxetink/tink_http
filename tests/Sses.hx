...
class Sses {
  ...
  @:variant([{ data: '123\n456' }], 'data: 123\ndata: 456\n\n')
  @:include public function encode(input:Array<Sse>, output:String) {
  ...
  @:variant('data: 123\ndata: 456\n\n', [{ data: '123\n456', event: 'message', retry: null, id: null }])
  @:include public function decode(input:String, output:Array<Sse>) {
